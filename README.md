...
**Увага!** З огляду на те, що бібліотека містить в собі велику кількість правил та цілу структуру нейромережі, при використанні в браузері можуть виникати проблеми зі швидкодією.
