 ...
 */
export declare function copyLetterCase(src: string, dest: string): string;
/**
 * Detects if a character is in the upper case at the specified index.
 */
export declare function isUpperCase(src: string, pos?: number): boolean;
/**
 * Detects if a character is in the lower case at the specified index.
 */
export declare function isLowerCase(src: string, pos?: number): boolean;
