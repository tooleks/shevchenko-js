...
function shevchenko(person, caseName) {
    ...
    var inflect = function inflect(type, name, gender, caseName) {
        var inflectedName = getInflectionFunctions()[type](name.toLowerCase(), gender, caseName);
...
function getInflectionFunctions() {
    return {
        ...
        lastName: function lastName(name, gender, caseName) {
            return mapCompoundNameSegments(name, function (name, index, length) {
        ...
        firstName: function firstName(name, gender, caseName) {
            return mapCompoundNameSegments(name, function (name) {
                var rule = shevchenko.getRules().filter(function (rule) {
...
function mapCompoundNameSegments(name, callback) {
    ...
    return segments.map(function (segment, index) {
        return callback(segment, index, segments.length);
    }).join(delimiter);
}
