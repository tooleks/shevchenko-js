      ...
      <div class="col">
        <div class="mt-3">
          ...
          <p>
            ...
            відповідно, наприклад, Диня (називний) -&gt; Дині (родовий), Синя (називний) -&gt;
            Синьої (родовий), Рий (називний) -&gt; Рия (родовий), Бурий (називний) -&gt; Бурого
            (родовий).
          </p>

          <p>
            При відмінюванні відбуваються зміни голосних та приголосних звуків згідно правил
            української мови, наприклад, Сивокінь (називний) -&gt; Сивоконя (родовий), Гичка
            (називний) -&gt; Гичці (давальний), але Чміль (називний) -&gt; Чміля (родовий).
          </p>
          ...
          <p>
            Складені імена, утворені поєднанням двох самостійних імен відмінюються за правилами
            відмінювання кожної складової частини, наприклад, Анна-Марія (називний) - Анни-Марії
            (родовий).
          </p>
        </div>
      </div>
