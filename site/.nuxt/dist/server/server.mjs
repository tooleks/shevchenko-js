...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.2a6aade5.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.2e215246.js").then((n) => n.i).then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default.7c6fe3b4.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.aacc77ac.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
