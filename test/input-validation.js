module.exports = (shevchenko) => {
  describe('shevchenko', () => {
    it('should throw an error for empty arguments list', () => {
      expect(() => shevchenko.inNominative()).toThrow(
        TypeError,
        '"anthroponym" must be an object.',
      );
      ...
      expect(() => shevchenko.inAccusative()).toThrow(
        TypeError,
        '"anthroponym" must be an object.',
      );
    ...
    it('should throw an error if unsupported gender provided', () => {
      ...
      expect(() => shevchenko.inNominative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.gender" must be one of the following: "male", "female".',
      );
      expect(() => shevchenko.inGenitive(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.gender" must be one of the following: "male", "female".',
      );
      expect(() => shevchenko.inDative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.gender" must be one of the following: "male", "female".',
      );
      expect(() => shevchenko.inAccusative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.gender" must be one of the following: "male", "female".',
      );
      expect(() => shevchenko.inAblative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.gender" must be one of the following: "male", "female".',
      );
      expect(() => shevchenko.inLocative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.gender" must be one of the following: "male", "female".',
      );
      expect(() => shevchenko.inVocative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.gender" must be one of the following: "male", "female".',
      );
    });
    ...
    it('should throw an error if provided first name is not a string', () => {
      ...
      expect(() => shevchenko.inNominative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.firstName" must be a string.',
      );
      expect(() => shevchenko.inGenitive(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.firstName" must be a string.',
    ...
    it('should throw an error if provided middle name is not a string', () => {
      ...
      expect(() => shevchenko.inNominative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.middleName" must be a string.',
      );
      expect(() => shevchenko.inGenitive(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.middleName" must be a string.',
    ...
    it('should throw an error if provided last name is not a string', () => {
      ...
      expect(() => shevchenko.inNominative(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.lastName" must be a string.',
      );
      expect(() => shevchenko.inGenitive(anthroponym)).toThrow(
        TypeError,
        '"anthroponym.lastName" must be a string.',
